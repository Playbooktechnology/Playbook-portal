...
| **7** | **Self-check** against the twelve-point publication checklist, the Moat Check, and `check-voice.mjs`. Bring the Moat Check's grade and its up-to-five concrete changes into the Step 8 presentation. | `references/voice-and-style.md` §12, `references/moat-check.md` |
